...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypefaceUtils.setBold(this,tv2);
        TypefaceUtils.setBook(this,tv3);
        TypefaceUtils.setHeavy(this,tv4);
        TypefaceUtils.setLight(this,tv5);
        TypefaceUtils.setMedium(this,tv6);
